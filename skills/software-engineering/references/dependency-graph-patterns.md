<!-- Part of the Software Engineering AbsolutelySkilled skill. Load this file when the agent needs guidance on decomposing tasks into dependency graphs, common DAG patterns, ASCII rendering, and wave assignment. -->
