<!-- Part of the Software-Engineering AbsolutelySkilled skill. Load this file when the agent needs detailed guidance on conducting the INTAKE phase, including question banks, scaling rules, and example sessions. -->

# Intake Playbook

The intake phase is the foundation of every Software-Engineering execution. A thorough intake prevents rework, missed requirements, and scope creep. This playbook provides the full question bank, scaling rules, and example sessions.
...
10. **Board persistence**: "Should the `.software-engineering/` board be git-tracked or gitignored?"
