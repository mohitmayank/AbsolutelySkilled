<!-- Part of the Software Engineering AbsolutelySkilled skill. Load this file when the agent needs guidance on executing tasks in parallel waves, agent orchestration, prompt templates, and error recovery. -->
