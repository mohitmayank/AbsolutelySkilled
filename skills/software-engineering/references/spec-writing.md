<!-- Part of the Software Engineering AbsolutelySkilled skill. Load this file when writing or reviewing design spec documents. -->

# Spec Writing

Complete reference for producing design spec documents during the software-engineering workflow. Covers the document template, section scaling rules, writing style, decision logging, and the reviewer checklist.
