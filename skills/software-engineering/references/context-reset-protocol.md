<!-- Part of the Software Engineering AbsolutelySkilled skill. Load this file when managing context during long-running build sessions. -->

# Context Reset Protocol

For long-running Software-Engineering sessions, context resets beat context compaction.
...
Before resetting, write a structured handoff to `.software-engineering/handoff.md`.
...
## Session State
- **Board path**: .software-engineering/board.md
...
4. Write the handoff document to `.software-engineering/handoff.md`
...
**State preserved in:**
- Board: .software-engineering/board.md (full task graph, research, plans, verification)
- Handoff: .software-engineering/handoff.md (session-specific context)

**To resume:** Re-invoke Software-Engineering in a new conversation. It will detect
the existing board and handoff, then pick up from Wave {next_wave}.
```

### Step 3: Resume After Reset

When Software-Engineering is invoked and detects both a board AND a handoff file:
...
- The new session invokes Software-Engineering, which detects the board and handoff
