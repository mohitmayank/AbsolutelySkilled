<!-- Part of the Software-Engineering AbsolutelySkilled skill. Load this file when the agent needs the full specification for the .software-engineering/board.md file, including format, status transitions, and examples. -->

# Board Format Specification

The `.software-engineering/board.md` file is the single source of truth for a Software-Engineering execution. It tracks everything from intake through convergence and is designed to be both human-readable and machine-parseable.
...
```
{project-root}/.software-engineering/board.md
```

The `.software-engineering/` directory may also contain:
...
When starting a new session and a `.software-engineering/board.md` exists:
...
### Resume Detection
At the start of any Software-Engineering invocation:
1. Check if `.software-engineering/board.md` exists
2. If yes, ask the user: "Found an existing Software-Engineering board. Resume it or start fresh?"
